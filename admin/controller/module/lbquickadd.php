<?php
class ControllerModuleLbQuickAdd extends Controller {
    private $error = array();

    public function index() {
        
		/* Start : Setting Table */
		$this->language->load('module/lbquickadd');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('lbquickadd', $this->request->post);
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('module/lbquickadd', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('module/lbquickadd', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );
		/* End : Module Breadcrumb */
		
		
		$this->data['insert'] = $this->url->link('module/lbquickadd/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['copy'] = $this->url->link('module/lbquickadd/copy', 'token=' . $this->session->data['token'] . $url, 'SSL');	
		$this->data['delete'] = $this->url->link('module/lbquickadd/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('module/lbquickadd/update', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url, 'SSL')
			);
		...
		$this->data['sort_name'] = $this->url->link('module/lbquickadd', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
		$this->data['sort_price'] = $this->url->link('module/lbquickadd', 'token=' . $this->session->data['token'] . '&sort=p.price' . $url, 'SSL');
		$this->data['sort_order'] = $this->url->link('module/lbquickadd', 'token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('module/lbquickadd', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->template = 'module/lbquickadd_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function getForm() {
		...
		$this->data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('module/lbquickadd', 'token=' . $this->session->data['token'] . $url, 'SSL'),
			'separator' => ' :: '
		);

		if (!isset($this->request->get['product_id'])) {
			$this->data['action'] = $this->url->link('module/lbquickadd/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$this->data['action'] = $this->url->link('module/lbquickadd/update', 'token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'] . $url, 'SSL');
		}

		$this->data['cancel'] = $this->url->link('module/lbquickadd', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->template = 'module/lbquickadd_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'module/lbquickadd')) {
