...
class ControllerCatalogInformation extends Controller { 
	...
	protected function getForm() {
		...
		$this->data['save_member_action'] = $this->url->link('catalog/information/saveMember', 'token=' . $this->session->data['token'] ."&information_id=".$this->request->get['information_id']. $url, 'SSL');
		$this->data['delete_member_action'] = $this->url->link('catalog/information/deleteMember', 'token=' . $this->session->data['token'] ."&information_id=".$this->request->get['information_id']. "&member_id=", 'SSL');
		$this->data['save_office_action'] = $this->url->link('catalog/information/saveOffice', 'token=' . $this->session->data['token'] ."&information_id=".$this->request->get['information_id']. $url, 'SSL');
		$this->data['delete_office_action'] = $this->url->link('catalog/information/deleteOffice', 'token=' . $this->session->data['token'] ."&information_id=".$this->request->get['information_id']. "&office_id=", 'SSL');
		
		
		$this->data['members'] = $this->model_catalog_information->getTeamMembers();
		$this->data['offices'] = $this->model_catalog_information->getOffices();
		
		$info_description = $this->model_catalog_information->getInformationDescriptions($this->request->get['information_id']);
		
		if (isset($this->request->get['information_id']) ){
		$this->data['thumb'] = "../image/".$info_description[1]['img_url'];
		$this->data['image'] = "../image/".$info_description[1]['img_url'];
		}
		...
		if (isset($this->request->post['information_description'])) {
			...
			$this->data['information_description'] = $info_description;//$this->model_catalog_information->getInformationDescriptions($this->request->get['information_id']);
		} else {
	...
	public function saveMember()
	{
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			$this->load->model('catalog/information');
			if ( isset($this->request->post['member_id']) && $this->request->post['member_id'] > 0)
			{
				$this->model_catalog_information->updateTeamMember($this->request->post['member_id'], $this->request->post);
			}
			else
			{
				$this->model_catalog_information->addTeamMember($this->request->post);
			}
		}
		$this->data['token'] = $this->session->data['token'];
		//$this->redirect($this->url->link('catalog/information/update', 'token=' . $this->session->data['token'] . '&information_id='.isset($this->request->get['information_id'])?$this->request->get['information_id']:'4', 'SSL'));
$this->getForm();
	}
	...
	public function deleteMember()
	{
		...
		{
			$this->load->model('catalog/information');
			$this->model_catalog_information->deleteTeamMember($this->request->get['member_id']);
		}
			$this->data['token'] = $this->session->data['token'];
		//$this->redirect($this->url->link('catalog/information/update', 'token=' . $this->session->data['token'] . '&information_id='.isset($this->request->get['information_id'])?$this->request->get['information_id']:'4', 'SSL'));
$this->getForm();
	...
	public function saveOffice()
	{
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			{
				$this->model_catalog_information->updateOffice($this->request->post['office_id'], $this->request->post);
			}
			else
			{
				$this->model_catalog_information->addOffice($this->request->post);
			}
		}
		$this->data['token'] = $this->session->data['token'];
		//$this->redirect($this->url->link('catalog/information/update', 'token=' . $this->session->data['token'] . '&information_id='.isset($this->request->get['information_id'])?$this->request->get['information_id']:'4', 'SSL'));
$this->getForm();
	...
	public function deleteOffice()
	{
		...
		{
			$this->load->model('catalog/information');
			$this->model_catalog_information->deleteOffice($this->request->get['office_id']);
		}
			$this->data['token'] = $this->session->data['token'];
		//$this->redirect($this->url->link('catalog/information/update', 'token=' . $this->session->data['token'] . '&information_id='.isset($this->request->get['information_id'])?$this->request->get['information_id']:'4', 'SSL'));
$this->getForm();
