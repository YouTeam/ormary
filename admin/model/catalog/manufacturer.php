...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		if (isset($data['bgimage'])) {
			$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET bgimage = '" . $this->db->escape(html_entity_decode($data['bgimage'], ENT_QUOTES, 'UTF-8')) . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
		}
		
		if (isset($data['manufacturer_description'])) {
			$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET manufacturer_description = '" . $this->db->escape($data['manufacturer_description']) . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
		}

		if (isset($data['manufacturer_style'])) {
			$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET style_id = '" . (int)$data['manufacturer_style'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
		}
	...
	public function getManufacturersStyles() {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "manufacturer_styles");
