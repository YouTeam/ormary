...
/*			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/emails/welcome_template.tpl')) {
				$template = $this->config->get('config_template') . '/template/emails/welcome_template.tpl';
			} else {
				$template = '';
			}*/
			...
			$mail = new Mail();	
			$mail->sendNotificationEmail($this->request->post['email'], '', $message, 'ORMARY password reset');
