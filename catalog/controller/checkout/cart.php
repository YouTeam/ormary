    ...
    public function index() {
        ...
        if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            foreach ($products as $product) {
                ...
                $this->data['total_cart_price'] += $product['price'] * $product['quantity'];
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/cart_empty.tpl')) {
                ...
                $this->load->model('tool/image');
            // get recommendations or the whats new products
            if (!$this->customer->isLogged()) {
            ...
            // get product recomendations for logged in users
            else {
    ...
    public function add() {
        ...
        if ($product_info) {
            ...
            if (!$json) {
                ...
                $json['total']['items_count'] = $this->cart->countProducts();
                $json['total']['subtotal_price'] = $this->currency->format($total_price);
            } else {
