...
class ModelAccountOrder extends Model {
	...
	public function getOrderAllStatuses($order_id) {
	...
	public function getOrderProductsWithDetails($order_id) {
		$query = $this->db->query("SELECT op.name as name, pd.description as description, p.image, op.quantity as product_quantity, op.price as product_price FROM " . DB_PREFIX . "order_product op INNER JOIN ".DB_PREFIX."product p on op.product_id = p.product_id inner join ".DB_PREFIX."product_description pd on op.product_id = pd.product_id WHERE order_id = '" . (int)$order_id . "'");
