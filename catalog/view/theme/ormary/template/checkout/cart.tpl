...
<div id="content" class="container cart"><?php echo $content_top; ?>
  ...
  <div class="steps clearfix">
	  ...
	  <a href="" class="step step1 active"><span class="light_font">Step 1:</span> Cart</a>
	  <a href="" class="step step2"><span class="light_font">Step 2:</span> Payment & Shipping</a>
	  <a href="" class="step step3"><span class="light_font">Step 3:</span> Place Order</a>
	</div>
    ...
    <div class="table_head clearfix">
        ...
        <?php foreach ($products as $product) { ?>
		  ...
		  <ul>
            ...
            <li class="light_font"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
              </li>
                <?php foreach ($product['option'] as $option) { ?>
                <li class="light_font"><span class="greytext"><?php echo $option['name']; ?>: </span><?php echo $option['value']; ?>
                </li><?php } ?>
              
            <li class="light_font"><?php echo $product['model']; ?></li>
			</ul></div>
            <div class="quantity">
            ...
            <a href="<?php echo $product['remove']; ?>">
              <img src="catalog/view/theme/ormary/image/del.png" alt="Remove"></a>
            </div>
 ...
 <!-- <?php /*if ($coupon_status || $voucher_status || $reward_status || $shipping_status) { ?>
  ...
  <div class="bottom_btns">
    <a href="<?php echo $continue; ?>" class="dark_btn"><?php echo $button_shopping; ?></a>
	<a href="<?php echo $checkout; ?>" class="dark_btn"><?php echo $button_checkout; ?></a>
  </div>
