...
<div class="container content my_ormary_profile_page">
    ...
    <div class="col-md-9 clearfix nopadding profile_password">
    	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="account_pass_form">           
            ...
            <div class="wrap_link">
               <a href="javascript:void(0)" onclick="validatePass()" class="black_btn">Save profile</a>
            </div>
        </form>
    </div>
</div>
...
function validatePass()
{
	$.ajax({
		...
		type: 'post',
		data: $('#account_pass_form input[name=\'password\'], #account_pass_form input[name=\'confirm\']'),
		dataType: 'json',
