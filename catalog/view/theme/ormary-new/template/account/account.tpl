...
<div class="container content my_ormary_page">
	...
	<div class="col-md-9 clearfix nopadding">
        <div class="orm_profile">
            ...
            <div class="about"><?php echo $biography; ?></div>
			<a href="<?php echo $edit; ?>" class="edit_my_profile">Edit my profile</a>
		</div>
        <div class="criteria clearfix">
            <a href="#" class="<?php if(!$orders_tab){?>active <?php }?>following_designers_to">Followed designers<span class="number"><?php print $follows_count; ?></span></a>
            ...
            <a href="#" class="<?php if($orders_tab){?>active <?php }?>my_orders_to">My orders</a>
        </div>
		<div>
			<div class="following_designers active" <?php if($orders_tab){?>style="display:none;"<?php }?> >
                <?php
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6">
                        <div class="wrap_designer_box">
                            <div class="designer_box_img">
                                <a href="index.php?route=product/manufacturer/info&manufacturer_id=<?php print $fl['mid']?>">
                                    <img src="<?php print $fl['image'];?>" alt="<?php print $fl['name'];?>">
                                </a>
                            </div>
                            ...
                            <div class="unfollow_btn">
                                <a href="javascript:void(0)" class="unfollow" id="<?php print $fl['mid']?>">Unfollow</a>
                            </div>
                        </div>
                    </div>
                <?php 
            ...
            <div class="recommended_designers" <?php if($orders_tab){?>style="display:none;"<?php }?> >
            	<?php
                ...
                ?>
                    <div class="col-md-4 col-sm-4 col-xs-6">
                        <div class="wrap_designer_box">
                            <div class="designer_box_img">
                                <a href="index.php?route=product/manufacturer/info&manufacturer_id=<?php print $rd['manufacturer_id']?>">
                                    <img src="<?php print $rd['image'];?>" alt="<?php print $rd['name'];?>">
                                </a>
                            </div>
                            <div class="designer_box_title">
                                <a href="index.php?route=product/manufacturer/info&manufacturer_id=<?php print $rd['manufacturer_id']?>"><?php print $rd['name'];?></a>
                            </div>
                            <div class="follow_btn">
                                <a href="javascript:void(0)" class="follow" id="<?php print $rd['manufacturer_id']?>">Follow</a>
                            </div>
                        </div>
                    </div>
				<?php 
            ...
            <div class="my_orders "<?php if($orders_tab){?>style="display:block;"<?php }?>>
                <table>
                    <thead>
                        <tr>
                            <td>Order No</td>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="price"><?php print str_replace('£', '&pound;', $o['total']);?></td>
                                <td class="succesfull"><?php print $o['status']?></td>
                            </tr>
						<?php 
                        }
                        ?>
