    ...
    <div class="col-md-9 clearfix nopadding basic_information">
    	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="account_form">
            ...
            <div class="wrap_input clearfix">
                ...
                <input type="text" name="website" value="<?php print $website;?>">
            </div>
            <div class="wrap_input clearfix">
                <div class="title">
                Biography
        ...
        <div class="disable_my_account">
            ...
            By disabling your account, your Fashionfeed will be stopped, and you will be logged out. All of your Wardrobe items and  profile settings will be saved. <br>
            Your account will be re-activated upon next login.
            </div>
            <div class="wrap_link">
